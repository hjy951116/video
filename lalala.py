  ...
  if column[n+1] == 1:
    ...
    for y in range (720):
      for x in range (1280):
        ...
        if deltay[y][x] > 10 and ye[y][x] > 0 and ve[y][x] < 0 and deltau[y][x] > 3 and ue[y][x] > 0:  #:
          print(y,x)          
          prev_img[y,x,2] = prev_img[y,x,2] - ye[y][x]*deltay[y][x] - ve[y][x]*1.14*deltav[y][x]
          prev_img[y,x,1] = prev_img[y,x,1] - ye[y][x]*deltay[y][x] + ue[y][x]*0.395*deltau[y][x] + ve[y][x]*0.581*deltav[y][x]
          prev_img[y,x,0] = prev_img[y,x,0] - ye[y][x]*deltay[y][x] - ue[y][x]*2.033*deltau[y][x]
        

    print(k+1,'flash')
    cv2.imwrite('%.1d-comp.jpg'%count,prev_img)
